...
export function SheetContentHeader({
  ...
  return (
    <>
      <div className='flex items-center gap-2 px-4 py-3 sticky top-0 bg-white z-10'>
      ...
      <div className='h-3 w-full bg-gradient-to-b from-black/10 to-transparent pointer-events-none z-[9] sticky top-[48px]' />
    </>
  )
}
